...
Server: The Chatter server is the foundation. Ideally it is ran on a machine and left to manage the chat. It will ask for the IP address to listen on and a shared secret. 

Client: The Chatter client allows for connection to the Chatter server. Clients can chat, upload, and download files as needed. 
